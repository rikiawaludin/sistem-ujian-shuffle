                ...
                <Tabs defaultValue="overview" className="w-full">
                    ...
                    <TabsContent value="questions" className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <Card>
                                {course.soal.length === 0 && (
                                    <p className="text-center text-gray-500 py-8">Belum ada soal / pertanyaan untuk mata kuliah ini.</p>
                                )}
                            </Card>
                        ...
                        <div className="space-y-4">
                            ...
                            <Card>
                                {course.ujian.length === 0 && (
                                    <p className="text-center text-gray-500 py-8">Belum ada pelaksanaan ujian untuk mata kuliah ini.</p>
                                )}
                            </Card>
                        </div>
                    </TabsContent>
